# You are given two dates as an array with three numbers - a year, month and day. For example:
...
def days_diff(a, b):
    return abs(datetime.datetime(a[0], a[1], a[2]) - datetime.datetime(b[0], b[1], b[2])).days
