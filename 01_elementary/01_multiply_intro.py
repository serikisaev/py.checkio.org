...
# and how to get the most out of solving them. When the mission is solved, one more station become available for you,
# containing more complex missions.
#
# So this mission is the easiest one. Write a function that will receive 2 numbers as input
